    ...
    <div className="relative h-[95vh] flex flex-col items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 px-4 ">
        ...
        <div className="flex flex-row flex-wrap justify-center gap-2 animate-fadeIn delay-500">
          {/* تعديل أزرار لتتناسب مع اللون الجديد */}
...
//           if (distance < 150) {
//             ctx.beginPath();
//             ctx.strokeStyle = `hsla(${(i * j) % 360}, 70%, 60%, ${
//               0.2 * (1 - distance / 150)
//             })`;
//             ctx.lineWidth = 0.5;
//             ctx.moveTo(particles[i].x, particles[i].y);
...
//         <div className="flex flex-row flex-wrap justify-center gap-2 animate-fadeIn delay-500">
//           <button className="px-5 py-1.5 sm:px-8 sm:py-3 text-xs sm:text-base bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium rounded-full hover:from-indigo-700 hover:to-purple-700 transition-all transform hover:scale-105 shadow shadow-indigo-500/20">
//             View Projects
//           </button>
//           <button className="px-5 py-1.5 sm:px-8 sm:py-3 text-xs sm:text-base bg-transparent border border-white/30 text-white font-medium rounded-full hover:bg-white/10 transition-all">
//             Contact Me
